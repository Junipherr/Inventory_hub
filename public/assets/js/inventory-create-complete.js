document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleSubmit(e) {
        ...
        .then(data => {
            if (data.success || data.redirected) {
                // Success - redirect will handle the success message
                window.location.href = data.redirect || "{{ route('inventory.create') }}";
            } else {
    ...
    function showError(message) {
        ...
        `;
        document.querySelector('.page-content').insertBefore(alert, document.querySelector('.page-content').firstChild);
