                                ...
                                <tbody>
                                    @foreach($availableItems as $item)
                                        @php
                                            ...
                                            $availableUnits = $item->units->where('status', '!=', 'Borrowed')->count();
                                        ...
                                        <tr class="item-row" 
                                            ...
                                            data-available-qty="{{ $availableUnits }}"
                                            data-total-qty="{{ $totalUnits }}">
                                            ...
                                            <td>
                                                <span class="badge bg-secondary">{{ $totalUnits }}</span>
                                            </td>
                                            <td>
                                                @if($isAvailable)
                                                    <span class="badge bg-success">{{ $availableUnits }}</span>
                                                @else
                                            ...
                                            <td>
                                                <button type="button" 
                                                        class="btn btn-sm {{ $isAvailable ? 'btn-success' : 'btn-secondary' }} request-borrow"
